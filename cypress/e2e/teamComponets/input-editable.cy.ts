describe('Test component', () => {
  it('should click on the button to test the Input Editable component', () => {
    ...
    cy.get('#7406-input-editable').shadow().find('[dt-button-edit="should-button-edit"]')
    // Renderização do button close
    cy.get('#7406-input-editable').shadow().find('[dt-button-close="should-button-close"]')
    // Renderização do button confirm
    cy.get('#7406-input-editable').shadow().find('[dt-button-confirm="should-button-confirm"]')
  });
});
